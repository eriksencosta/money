...
/*
 * This file was auto-generated by running the "generateCryptoCurrenciesDataClasses" Gradle task. Always run the task
...
import com.eriksencosta.money.currency.crypto.data.CurrenciesCodes
import com.eriksencosta.money.currency.crypto.data.CurrenciesData
import com.eriksencosta.money.currency.crypto.data.CurrenciesLookup
import com.eriksencosta.money.currency.crypto.data.CurrenciesSecondaryCodes

internal object CryptoCurrencyBundle : CurrencyBundle {
    // private const val NUMBER_OF_CURRENCIES: Int = 2283
    private const val CODES_REGEX_PATTERN: String = "[0-9BCDFGHJKLMNPQRSTVWXZ]{9}"
    private const val SECONDARY_CODES_REGEX_PATTERN: String = "[\$\\-.0-9A-Zabceghijklmnopstuvwx]{1,12}"
